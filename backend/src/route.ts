...
export class Route {
    ...
    public readonly endpoint_str: string;
    public readonly id: string;
    public readonly is_regex: boolean;
    public readonly params: { name: string, required: boolean }[] = []; // path param names.
    private matcher?: {
        regex: RegExp;
    ...
    private _create_route_matcher(pattern: string) {
    ...
    private static _stringify_endpoint_regex(re: RegExp): string {
        let src = re.source;
        // strip ^…$ anchors
