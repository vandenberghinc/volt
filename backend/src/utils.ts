...
export namespace Utils {
    ...
    const content_type_mimes: Map<string, string> = new Map([
        [".html", "text/html"],
        [".htm", "text/html"],
        [".shtml", "text/html"],
        [".css", "text/css"],
    ...
    export function mime_type(extension: string): string | null {
    ...
    const compressed_extensions: Set<string> = new Set([
        ".png",
        ".jpg",
        ".jpeg",
        ".gif",
    ...
    export function is_compressed_extension(extension: string): boolean {
        const ext = extension.startsWith(".") ? extension.toLowerCase() : `.${extension.toLowerCase()}`;
        return compressed_extensions.has(ext);
    }

    // Compressed content type.
    const compressed_content_types: Set<string> = new Set([
    ...
    export function is_compressed_content_type(content_type: string): boolean {
