...
(function(Mail2) {
  ...
  (function(Attachment2) {
    Attachment2.encodings = /* @__PURE__ */ new Set(["base64", "hex", "utf8", "utf-8", "binary", "latin1"]);
    function is(a) {
      return a && typeof a === "object" && "name" in a && (!("path" in a) || typeof a.path === "string") && (!("mime_type" in a) || typeof a.mime_type === "string") && (!("charset" in a) || typeof a.charset === "string") && (!("bytes" in a) || (Buffer.isBuffer(a.bytes) || a.bytes instanceof Uint8Array)) && (!("content" in a) || typeof a.content === "string") && (!("encoding" in a) || Attachment2.encodings.has(a.encoding)) && (!("compressed" in a) || typeof a.compressed === "boolean");
    }
    Attachment2.is = is;
    let RestAPI;
    (function(RestAPI2) {
      function is2(a) {
        return a && typeof a === "object" && "name" in a && (!("path" in a) || typeof a.path === "string") && (!("mime_type" in a) || typeof a.mime_type === "string") && (!("charset" in a) || typeof a.charset === "string") && (!("compressed" in a) || typeof a.compressed === "boolean") && (!("content" in a) || typeof a.content === "string") && (!("encoding" in a) || Attachment2.encodings.has(a.encoding)) && (!("url" in a) || typeof a.url === "string");
      }
      RestAPI2.is = is2;
      RestAPI2.Schema = {
        ...
        encoding: { type: "string", enum: Array.from(Attachment2.encodings), required: false },
        url: { type: "string", required: false }
      };
    })(RestAPI = Attachment2.RestAPI || (Attachment2.RestAPI = {}));
    let Native;
    (function(Native2) {
      function is2(a) {
        return a && typeof a === "object" && ("content" in a || "path" in a || "filename" in a);
      }
      Native2.is = is2;
    })(Native = Attachment2.Native || (Attachment2.Native = {}));
  })(Attachment = Mail2.Attachment || (Mail2.Attachment = {}));
})(Mail || (Mail = {}));
