...
(function(Utils2) {
  ...
  Utils2.fill_templates = fill_templates;
  const content_type_mimes = /* @__PURE__ */ new Map([
    [".html", "text/html"],
    [".htm", "text/html"],
    [".shtml", "text/html"],
    [".css", "text/css"],
  ...
  Utils2.mime_type = mime_type;
  const compressed_extensions = /* @__PURE__ */ new Set([
    ".png",
    ".jpg",
    ".jpeg",
    ".gif",
  ...
  Utils2.is_compressed_extension = is_compressed_extension;
  const compressed_content_types = /* @__PURE__ */ new Set([
  ...
  Utils2.is_compressed_content_type = is_compressed_content_type;
  ...
  Utils2.get_currency_symbol = get_currency_symbol;
  ...
  Utils2.get_compiled_cache = get_compiled_cache;
  function set_compiled_cache(path, data, hash) {
    path.save_sync(data);
    new vlib.Path(path.str() + ".hash").save_sync(hash);
  }
  Utils2.set_compiled_cache = set_compiled_cache;
})(Utils || (Utils = {}));
