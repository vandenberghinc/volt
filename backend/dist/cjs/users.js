...
class Users {
  ...
  _parse_uid_from_token_api_key(input, expected_prefix) {
    ...
    if (uid.length === 0 || !Users._is_valid_uid(uid))
      return void 0;
  ...
  async _create_user_cookie(stream, uid) {
    if (typeof uid === "string") {
      stream.set_cookie(`UserID=${encodeURIComponent(uid ?? "")}; Path=/; SameSite=Lax; Secure; HttpOnly;`);
      ...
      stream.set_cookie(`UserID=-1; Path=/; SameSite=Lax; Secure; HttpOnly;`);
  ...
  _reset_cookies(stream) {
    ...
    stream.set_cookie(`UserID=; Max-Age=0; Path=/; Expires=${past}; SameSite=Lax; Secure; HttpOnly;`);
  ...
  async _initialize() {
    ...
    this.server.endpoint({
      ...
      callback: async (stream, params) => {
        const query = typeof params.path === "string" ? { uid: stream.uid, path: params.path } : { ...params.path, uid: stream.uid };
        return stream.send({
          status: import_status.Status.success,
      ...
      callback: async (stream) => {
        ...
        if (params.attachments) {
          ...
          if (keys.length > MAX_ATTACHMENTS) {
            throw new ExternalError({ status: import_status.Status.bad_request, type: "TooManyAttachments", message: `Too many attachments. Max is ${MAX_ATTACHMENTS}.` });
          }
          for (const key of keys) {
            const raw = params.attachments[key];
            const is_base64 = /^[A-Za-z0-9+/]+={0,2}$/.test(raw) && raw.length % 4 === 0;
            const buf = Buffer.from(raw, is_base64 ? "base64" : "utf-8");
            if (buf.length > MAX_BYTES) {
              throw new ExternalError({ status: import_status.Status.bad_request, type: "AttachmentTooLarge", message: `${key} too large, maximum size is 5 MB.` });
            }
...
(function(Users2) {
  ...
  (function(Endpoints2) {
    let UpdateUser;
    /* @__PURE__ */ (function(UpdateUser2) {
      ;
    })(UpdateUser = Endpoints2.UpdateUser || (Endpoints2.UpdateUser = {}));
    let ActivateUser;
    /* @__PURE__ */ (function(ActivateUser2) {
      ;
    })(ActivateUser = Endpoints2.ActivateUser || (Endpoints2.ActivateUser = {}));
    let ChangePassword;
    /* @__PURE__ */ (function(ChangePassword2) {
      ;
    })(ChangePassword = Endpoints2.ChangePassword || (Endpoints2.ChangePassword = {}));
    let DeleteUser;
    /* @__PURE__ */ (function(DeleteUser2) {
      ;
    })(DeleteUser = Endpoints2.DeleteUser || (Endpoints2.DeleteUser = {}));
    let GenerateAPIKey;
    /* @__PURE__ */ (function(GenerateAPIKey2) {
      ;
    })(GenerateAPIKey = Endpoints2.GenerateAPIKey || (Endpoints2.GenerateAPIKey = {}));
    let HasAPIKey;
    /* @__PURE__ */ (function(HasAPIKey2) {
      ;
    })(HasAPIKey = Endpoints2.HasAPIKey || (Endpoints2.HasAPIKey = {}));
    let RevokeAPIKey;
    /* @__PURE__ */ (function(RevokeAPIKey2) {
      ;
    })(RevokeAPIKey = Endpoints2.RevokeAPIKey || (Endpoints2.RevokeAPIKey = {}));
    let LoadUserData;
    /* @__PURE__ */ (function(LoadUserData2) {
      ;
    })(LoadUserData = Endpoints2.LoadUserData || (Endpoints2.LoadUserData = {}));
    let SetUserData;
    /* @__PURE__ */ (function(SetUserData2) {
      ;
    })(SetUserData = Endpoints2.SetUserData || (Endpoints2.SetUserData = {}));
    let DeleteUserData;
    /* @__PURE__ */ (function(DeleteUserData2) {
      ;
    })(DeleteUserData = Endpoints2.DeleteUserData || (Endpoints2.DeleteUserData = {}));
    let LoadProtectedUserData;
    /* @__PURE__ */ (function(LoadProtectedUserData2) {
      ;
    })(LoadProtectedUserData = Endpoints2.LoadProtectedUserData || (Endpoints2.LoadProtectedUserData = {}));
