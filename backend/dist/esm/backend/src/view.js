...
export class View {
    ...
    constructor({ source, 
    // callback = null,
    includes = [], links = [], templates = {}, meta = new Meta(), jquery = false, lang = "en", body_style = null, splash_screen = undefined, tree_shaking = false, mangle = false, min_device_width = 600, _src, }) {
        // Arguments.
        this.source = source;
