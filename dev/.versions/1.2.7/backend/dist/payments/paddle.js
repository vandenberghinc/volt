...
class Paddle {
    ...
    */
    async get_payments({ uid, days = 30, limit = null, status = null, }) {
        // Get path.
    ...
    /*  @docs:
        ...
        @param:
            ...
            @desc: Limit the amount of response payment objects.
    */
    async get_refundable_payments({ uid, days = 30, limit = null, }) {
        const payments = [];
    ...
    /*  @docs:
        ...
        @param:
            ...
            @desc: Limit the amount of response payment objects.
    */
    async get_refunded_payments({ uid, days = 30, limit = null, }) {
        const payments = [];
        const all_payments = await this.get_payments({ uid, days, limit, status: "paid" });
        all_payments.iterate((payment) => {
            const line_items = [];
    ...
    /*  @docs:
        ...
        @param:
            ...
            @desc: Limit the amount of response payment objects.
    */
    async get_refunding_payments({ uid, days = null, limit = null, }) {
        const payments = [];
        const all_payments = await this.get_payments({ uid, days, limit, status: "paid" });
        all_payments.iterate((payment) => {
            const line_items = [];
