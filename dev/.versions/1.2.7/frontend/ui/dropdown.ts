...
export class DropdownElement extends VStackElement {
	...
	public content_items: (AnchorHStackElement | HStackElement)[];
	...
	public _content_padding: (string | number)[];
	public _content_margin: (string | number)[];
	...
	*/
	...
	content_padding(...args: (string | number)[]): this | (string | number)[] {
	...
	*/
	...
	content_margin(...args: (string | number)[]): this | (string | number)[] {
