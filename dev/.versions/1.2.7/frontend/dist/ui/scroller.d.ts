...
export declare class ScrollerElement extends ScrollerElement_base {
...
export declare const Scroller: (...args: any[]) => any;
export declare class VirtualScrollerElement extends ScrollerElement {
    constructor(...children: any[]);
    set_default(): this;
    overflow(): string;
    overflow(value: string): this;
