...
export declare class CodeBlockElement extends CodeBlockElement_base {
    language?: string;
...
export declare const CodeBlock: (...args: any[]) => any;
...
export declare class CodePreElement extends CodePreElement_base {
...
export declare const CodePre: (...args: any[]) => any;
...
export declare class CodeLineElement extends CodeLineElement_base {
    constructor(text: string);
    static fill(text: any, codeline_callback?: () => any): string;
}
export declare const CodeLine: (...args: any[]) => any;
...
export declare const MultiLanguageCodeBlock: (...args: any[]) => any;
export {};
