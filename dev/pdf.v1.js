...
/*
        _build_v1(doc, x, y, dry = false) {
            ...
            if (E.is_text || E.is_img) {
                ...
                if (!dry) {
                    ...
                    if (!dry && this._id != null) {
                        doc._volt_ids[this._id] = doc._volt_page_nr;
                    }
            ...
            if (this.type === "PDF") {
                ...
                // Links.
                doc._volt_hrefs.iterate((item) => {
                    console.log(item)
                    doc.switchToPage(item.page);
                    doc.link(...item.args.concat(doc._volt_ids[item.href]));
                })
            ...
            // Logs.
            // if (!dry) {
            //     console.log("post", {x, y, page: doc._volt_page_nr}, this._text)
            // }
