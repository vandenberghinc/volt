...
if (require("fs").existsSync("/Volumes/persistance/")) {
    vlib = require("/Volumes/persistance/private/dev/vinc/vlib/js/dist/vlib.js")
    vhighlight = require("/Volumes/persistance/private/dev/vinc/vhighlight/vhighlight.js")    
} else {
    vlib = require("/Users/administrator/persistance/private/dev/vinc/vlib/js/dist/vlib.js")
