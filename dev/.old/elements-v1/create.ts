...
import { VElement, isVElement, VElementClass, VElementInstance, NativeElementBase } from "./types.js"
...
const velement_extensions: VElementExtensionRecord = {};
const velement_classes: any[] = [];
...
export const native_elements =  {
    ...
    default: HTMLElement,
    style: class B {
		// Always use a raw obj since `HTMLElement.style` does not support new attrs like `duration` and `delay`.
...
export function create<DerivedHTMLElement extends HTMLElement = HTMLElement>(
	{
		type,
		tag,
		default_style, 
		...
		type: string,
		tag: keyof typeof native_elements,
		default_style?: Record<string, any>,
		default_attributes?: Record<string, any>,
		default_events?: Record<string, any>,
	}
)
// : VElementClass & (new () => NativeElementBase<DerivedHTMLElement> & VElementInstance)
// : BaseElementClass<DerivedHTMLElement>
: VElementClass<DerivedHTMLElement>
// : ({
//     new(): NativeElementBase<DerivedHTMLElement> & VElement;
//     // @ts-ignore
//     prototype: NativeElementBase<DerivedHTMLElement> & VElement;
...
// })
{
	...
	*/
	class VBaseElement extends Base implements DerivedHTMLElement, HTMLElement {
			...
			return new Promise((resolve) => {
				...
				const split_text = (text: string, text_style: string | null = null) => {
					...
					for (let w = 0; w < words.length; w++) {
						const word_span = new SpanElement()
						...
						for (let c = 0; c < words[w].length; c++) {
							const span = new SpanElement(words[w][c])
								.white_space("pre")
								.display("inline-block")
								.opacity(0)
						...
						if (w < words.length - 1) {
							word_span.append(new SpanElement(" ").white_space("pre"));
						}
		 ...
		 *     @description Returns the instance of the element for chaining.
		 */
		on_event(id: string, callback: (element: this, args: Record<string, any>) => any): this {
		 ...
		 * @funcs: 2
		 */
		parent<T = undefined | HTMLElement | VBaseElement>(): T;
		parent(value: object): this;
		parent<T = undefined | HTMLElement | VBaseElement>(value?: object): T | this {
			if (value == null) {
		...
		readonly(value?: boolean): boolean | this {
			if (value == null) { return typeof super.readOnly === "boolean" ? super.readOnly : (super.readOnly === "true" || super.readOnly === "True" || super.readOnly === "TRUE" || super.readOnly === "1"); }
		...
		async(value?: boolean): boolean | this {
			if (value == null) { return typeof super.async === "boolean" ? super.async : (super.async === "true" || super.async === "True" || super.async === "TRUE" || super.async === "1"); }
			super.async = value;
			return this;
		}
		...
		auto_play(value?: boolean): this | boolean {
			if (value == null) { return typeof super.autoplay === "boolean" ? super.autoplay : (super.autoplay === "true" || super.autoplay === "True" || super.autoplay === "TRUE" || super.autoplay === "1"); }
		...
		checked(value?: boolean): this | boolean {
			if (value == null) { return typeof super.checked === "boolean" ? super.checked : (super.checked === "true" || super.checked === "True" || super.checked === "TRUE" || super.checked === "1"); }
			super.checked = value;
			return this;
		}
		...
		cols(value?: number): this | null | number {
			if (value == null) { return this._try_parse_float(super.cols, null); }
			super.cols = value;
			return this;
		}
		...
		colspan(value?: number): this | null | number {
		    if (value == null) { return this._try_parse_float(super.colspan, null); }
		    super.colspan = value;
		    return this;
		}
		...
		content_editable(value?: boolean): boolean | this {
			if (value == null) { return typeof super.contenteditable === "boolean" ? super.contenteditable : (super.contenteditable === "true" || super.contenteditable === "True" || super.contenteditable === "TRUE" || super.contenteditable === "1"); }
		...
		controls(value?: boolean): this | boolean {
			if (value == null) { return typeof super.controls === "boolean" ? super.controls : (super.controls === "true" || super.controls === "True" || super.controls === "TRUE" || super.controls === "1"); }
		...
		disabled(value?: boolean): boolean | this {
			if (value == null) { return typeof super.disabled === "boolean" ? super.disabled : (super.disabled === "true" || super.disabled === "True" || super.disabled === "TRUE" || super.disabled === "1"); }
		...
		draggable(value?: boolean): boolean | this {
			if (value == null) { return typeof super.draggable === "boolean" ? super.draggable : (super.draggable === "true" || super.draggable === "True" || super.draggable === "TRUE" || super.draggable === "1"); }
		...
		is_map(value?: boolean): boolean | this {
			if (value == null) { return typeof super.ismap === "boolean" ? super.ismap : (super.ismap === "true" || super.ismap === "True" || super.ismap === "TRUE" || super.ismap === "1"); }
			super.ismap = value;
			return this;
		}
		...
		loop(value?: boolean): this | boolean {
			if (value == null) { return typeof super.loop === "boolean" ? super.loop : (super.loop === "true" || super.loop === "True" || super.loop === "TRUE" || super.loop === "1"); }
			super.loop = value;
			return this;
		}
		 ...
		 */
		multiple(): string;
		multiple(value: string): this;
		multiple(value?: string): string | this {
		...
		muted(value?: boolean): boolean | this {
			if (value == null) { return typeof super.muted === "boolean" ? super.muted : (super.muted === "true" || super.muted === "True" || super.muted === "TRUE" || super.muted === "1"); }
			super.muted = value;
			return this;
		}
		...
		no_validate(value?: boolean): this | boolean {
			if (value == null) { return typeof super.novalidate === "boolean" ? super.novalidate : (super.novalidate === "true" || super.novalidate === "True" || super.novalidate === "TRUE" || super.novalidate === "1"); }
		...
		open(value?: boolean): boolean | this {
			if (value == null) { return typeof super.open === "boolean" ? super.open : (super.open === "true" || super.open === "True" || super.open === "TRUE" || super.open === "1"); }
			super.open = value;
			return this;
		}
		...
		optimum(value?: number): this | null | number {
			if (value == null) { return this._try_parse_float(super.optimum, null); }
			super.optimum = value;
			return this;
		}
		...
		required(value?: boolean): boolean | this {
		    if (value == null) { return typeof super.required === "boolean" ? super.required : (super.required === "true" || super.required === "True" || super.required === "TRUE" || super.required === "1"); }
		...
		reversed(value?: boolean): this | boolean {
			if (value == null) { return typeof super.reversed === "boolean" ? super.reversed : (super.reversed === "true" || super.reversed === "True" || super.reversed === "TRUE" || super.reversed === "1"); }
		...
		rows(value?: number): null | number | this {
			if (value == null) { return this._try_parse_float(super.rows, null); }
			super.rows = value;
			return this;
		}
		...
		selected(value?: boolean): boolean | this {
			if (value == null) { return typeof super.selected === "boolean" ? super.selected : (super.selected === "true" || super.selected === "True" || super.selected === "TRUE" || super.selected === "1"); }
		...
		size(value?: number): null | number | this {
		    if (value == null) { return this._try_parse_float(super.size, null); }
		    super.size = value;
		    return this;
		}
		...
		span(value?: number): this | null | number {
			if (value == null) { return this._try_parse_float(super.span, null); }
			super.span = value;
			return this;
		}
		...
		spell_check(value?: boolean): boolean | this {
			if (value == null) { return typeof super.spellcheck === "boolean" ? super.spellcheck : (super.spellcheck === "true" || super.spellcheck === "True" || super.spellcheck === "TRUE" || super.spellcheck === "1"); }
		...
		start(value?: number): number | null | this {
			if (value == null) { return this._try_parse_float(super.start, null); }
			super.start = value;
			return this;
		}
		...
		step(value?: number): this | null | number {
			if (value == null) { return this._try_parse_float(super.step, null); }
			super.step = value;
			return this;
		}
	...
	// Extend class.
	Object.entries(velement_extensions).forEach(([name, func]) => {
		if (typeof func === "function") {
			VBaseElement.prototype[name] = func;
		} else {
			VBaseElement[name] = func;
		}
	})

	// Support extending.
	velement_classes.push(VBaseElement);

	// Register.
	customElements.define("v-base-" + type.toLowerCase(), VBaseElement as any, {extends: tag});

	// Return class.
	return VBaseElement as any;
};
...
// Type for the extension function parameters
type VElementExtensionFunction = (this: VElement, ...args: any[]) => any;
type VElementExtensionRecord = Record<string, VElementExtensionFunction | any>;

// Extend.
export function extend<T extends VElementExtensionRecord>(extension: T) {
    Object.assign(velement_extensions, extension);
    velement_classes.forEach(Class => {
        Object.assign(Class, extension);
    });
};
...
// VBaseElement class.
// @Elements.register
// export class VBaseElement extends create({type: "VElement", tag: "div"}) {
// 	constructor() { super(); }
// };

// Span element.
export class SpanElement extends create({
	type: "Span",
	tag: "span",
	default_style: {},
}) {
	constructor(inner_html?: string) {
		...
		// Set text.
		if (inner_html) { this.inner_html(inner_html); }
	}
}
customElements.define("v-base-span-0", SpanElement as any, {extends: "span"});
declare module '../ui/any_element.d.ts' { interface AnyElementMap { SpanElement: SpanElement }}

// @test
// (new SpanElement() as SpanElement & {append(...children: any[]): SpanElement}).append("HI").margin(0)
