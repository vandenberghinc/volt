...
/**
 * Block element for displaying code with optional syntax highlighting, line numbers, and animations.
 */
export class CodeBlockElement extends VElementTagMap.code {
     ...
     */
    hide_scrollbar(): this {
        this.content.classList.add("volt_hide_scrollbar");
        return this;
    }
    /**
     ...
     */
    show_scrollbar(): this {
        this.content.classList.remove("volt_hide_scrollbar");
        return this;
    }
...
/**
 * Preformatted code element that handles tokenization, highlighting, and optional typing animation.
 */
...
export class CodeLineElement extends VElementTagMap.span {
    ...
    constructor(text?: string) {
        ...
        // Set text.
        if (text) { this.text(text); } // never use inner html also because the text may content html entities.
