...
(function (Users) {
    ...
    (function (Endpoints) {
        ...
        (function (UpdateUser) {
            ;
        })(UpdateUser = Endpoints.UpdateUser || (Endpoints.UpdateUser = {}));
        /** The activate user endpoint. */
        let ActivateUser;
        (function (ActivateUser) {
            ;
        })(ActivateUser = Endpoints.ActivateUser || (Endpoints.ActivateUser = {}));
        /** The change password endpoint. */
        let ChangePassword;
        (function (ChangePassword) {
            ;
        })(ChangePassword = Endpoints.ChangePassword || (Endpoints.ChangePassword = {}));
        /** The delete user endpoint. */
        let DeleteUser;
        (function (DeleteUser) {
            ;
        })(DeleteUser = Endpoints.DeleteUser || (Endpoints.DeleteUser = {}));
        /** The generate api key endpoint. */
        let GenerateAPIKey;
        (function (GenerateAPIKey) {
            ;
        })(GenerateAPIKey = Endpoints.GenerateAPIKey || (Endpoints.GenerateAPIKey = {}));
        /** The has api key endpoint. */
        let HasAPIKey;
        (function (HasAPIKey) {
            ;
        })(HasAPIKey = Endpoints.HasAPIKey || (Endpoints.HasAPIKey = {}));
        ...
        (function (LoadUserData) {
            ;
        })(LoadUserData = Endpoints.LoadUserData || (Endpoints.LoadUserData = {}));
        /** The set public user data endpoint. */
        let SetUserData;
        (function (SetUserData) {
            ;
        })(SetUserData = Endpoints.SetUserData || (Endpoints.SetUserData = {}));
        /** The delete public user data endpoint. */
        let DeleteUserData;
        (function (DeleteUserData) {
            ;
        })(DeleteUserData = Endpoints.DeleteUserData || (Endpoints.DeleteUserData = {}));
        /** The load protected user data endpoint. */
        let LoadProtectedUserData;
        (function (LoadProtectedUserData) {
            ;
        })(LoadProtectedUserData = Endpoints.LoadProtectedUserData || (Endpoints.LoadProtectedUserData = {}));
